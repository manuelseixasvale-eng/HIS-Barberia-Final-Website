...
export default function Footer() {
  return (
    ...
    >
      ...
      >
        <span
          className="font-serif text-[28vw] text-his-white leading-none"
          style={{ opacity: 0.018, letterSpacing: "-0.02em" }}
        >
          HIS
        </span>
      </div>
        ...
        <div className="py-16 md:py-20 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            <div className="flex flex-col leading-none">
              <span className="font-serif text-[3rem] text-his-white tracking-[0.02em] leading-none">
                HIS
              </span>
