...
export const metadata = {
  title: "HIS Clásica — Barbería & Estética en Madrid",
  description: "HIS Clásica: barbería y estética masculina de alta gama en el barrio de Salamanca, Madrid. Cortes clásicos, afeitado tradicional y ritual completo.",
};
